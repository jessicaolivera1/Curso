...
public class TC005Admin_CreateUserDisabled_POM {
	...
	public void beforeTest() {
		...
		this.infoData[2]= seleniumWrapper.getJSONValue(this.getClass().getSimpleName(), "dropStatus");
		this.infoData[3]= seleniumWrapper.getJSONValue(this.getClass().getSimpleName(), "passwordNewUser");
	...
	@Test
	public void TC005Admin_CreateUserDisabled_Script() {
		...
		//Step 1
		 ...
		 // Step 5
		  ...
		  um.addNewUserDataDisabled(infoData);
