...
public class GlobalVariables {
	...
	public static final String CHROME_DRIVER_PATH = "./src/test/resources/drivers/chrome/v91chromedriver.exe";
	public static final String CHROME_DRIVER_PATH_LINUX = "./src/test/resources/drivers/chromeLinux/chromedriver";
	...
	public static final String TC003_NAME = "TC003Admin_AddNewUser_POM";
